...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi ColorColumn ctermbg=9 ctermfg=233 cterm=NONE guibg=#222244 guifg=NONE gui=NONE
    ...
    " hi CursorLine ctermbg=201 ctermfg=233 cterm=NONE guibg=#ea00d9 guifg=NONE gui=NONE
    hi CursorLine ctermbg=201 ctermfg=233 cterm=NONE guibg=#222244 guifg=NONE gui=NONE
